...
const Navigation = () => {
    ...
    return (
        <nav className={`fixed top-0 left-0 w-full z-50 transition-all duration-300 ${scrolled || mobileMenuOpen ? 'bg-[#111111]/95 backdrop-blur-md py-2' : 'bg-[#111111] py-4'} border-b border-white/5`}>
