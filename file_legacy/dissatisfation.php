...
if ($user['nama'] == 'BAROD') {
	...
	header("Location: dissatisfationCS.php");
	exit;
}
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane show active" id="survey">
                                            ...
                                            <a class="mt-1" target="_blank" href="belumpkt.php"><?=$pdi?> Belum WA - Reminder Belum WA/PKT</a>
                                            <br><br>
                                                        <div class="row">
                                                            <div class="col-lg-4">
                                                                <!-- Single Date Picker -->
                                            ...
                                            <table id="basic-datatable" class="table dt-responsive nowrap w-100">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="#" class="text-<?=$statuscolor?>" data-bs-toggle="popover" data-bs-placement="top" data-bs-trigger="hover" title="<?php echo $row["time"] ?>"><?php echo $row["telp"] ?></a> | 
                                                            <a target="_blank" href="wadissatisfaction.php?id=<?php echo $row["id"] ?>&via=wa" class="text-success"><i class="mdi mdi-whatsapp"></i></a>
                                                        </td>
                                                        <td>
                                                        ...
                                                        ?>
                                                        <td>
                                                            <a href="#" data-bs-toggle="popover" data-bs-placement="top" data-bs-trigger="hover" data-bs-content="<?=$estlink?>" title="Batas Autocomplete"><span class="badge bg-<?=$badgecolor?>"><?=$textlink?></span></a>
                                                        </td>
                                                        <td>
                                            ...
                                            <table id="datatable-buttons" class="table table-striped dt-responsive w-100">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?=formatTanggalIndonesia($row["tgl_srvy"])?></td>
